...
var deviceSettings = { isWebGL: !1, isAndroid: null, isIEMobile: null, isiPod: null, isiPhone: null, isiPad: null, isiOS: null, isMobile: null, isTablet: null, isWinSafari: null, isMacSafari: null };
function setupDeviceSettings() {
    ...
    deviceSettings.isIEMobile ||
    deviceSettings.isAndroid ||
    deviceSettings.isiPhone ||
    deviceSettings.isiPad ||
    "ipad" === e ||
    "iphone" === e ||
    "ipod" === e ||
    "android" === e ||
    ...
    "blackberry" === e ||
    "linux armv7l" === e
        ? ((deviceSettings.isMobile = !0), (document.body.className += "isMobile"))
        : (document.body.className += "isDesktop");
}
var episode_init_time = Date.now(),
    episode_total_time = 500,
    done_received = 1,
    send_a,
    send_r,
    send_i,
    ...
    rateCurrent = 0,
    rateSpeedSize = 1,
    translationPulseSize = 0.001,
    rotationPulseSize = 0.5,
    hitArray = [],
    hitRaycaster = new THREE.Raycaster(),
...
function initWebgl() {
    setupDeviceSettings(),
        ...
        gsap.set(".worm", { transformOrigin: "center center" }),
        gsap.set("#worm-roll", { drawSVG: "50% 50%", rotation: 90 }),
        gsap.set("#worm-pitch", { drawSVG: "50% 50%", rotation: 180 }),
        gsap.set("#worm-yaw", { drawSVG: "50% 50%", rotation: -90 }),
        gsap.set("#hud-worms", { autoAlpha: 1, display: "block" }),
        gsap.set("#hud, #hud-darken, #iss_target, #navball, #translation-status, #rotation-controls, #translation-controls, #helpers, #instructions", { autoAlpha: 0 }),
        gsap.set("#hud-tips, #navball, #rotation-controls, #translation-controls", { z: 1 }),
        (scene = new THREE.Scene()),
        (scene.fog = new THREE.Fog(0, 0, 6e7)),
        (camera = new THREE.PerspectiveCamera(35, width / height, 0.5, 6e7)),
...
var texturesLoaded,
    ...
    jsonLoader = new THREE.FileLoader(loadingManager),
    textureLoader = new THREE.TextureLoader(loadingManager);
function startPreloader() {
    gsap.set("#preloader-circle .circle-color, #preloader-circle .circle-grey", { drawSVG: "0% 0%", autoAlpha: 0 }), gsap.set("#preloader-circle", { rotation: -90 });
    var t = new TimelineMax({ paused: !0 });
    t.fromTo("#interactive", 3, { autoAlpha: 0 }, { autoAlpha: 1, ease: "none" }, 0),
        t.fromTo("#preloader-circle .circle-grey", 3, { drawSVG: "0% 0%" }, { drawSVG: "0% 102%", ease: "expo.inOut" }, 0),
        t.to("#preloader-circle .circle-color", 1, { autoAlpha: 1 }, 0),
        t.fromTo("#preloader-inner, #preloader-circle .circle-grey", 1, { autoAlpha: 0 }, { autoAlpha: 1, ease: "none" }, 0),
        t.play(0);
}
...
function initPreloader() {
    (earthTexture = deviceSettings.isMobile ? textureLoader.load("img/earth_mobile.jpg") : textureLoader.load("img/earth.jpg")),
        ...
        (loadingManager.onProgress = function (t, e, o) {
            renderer.compile(scene, camera), (texturesTotal = o), (texturesLoaded = e);
        }),
...
function hidePreloader() {
    ...
    t.to("#preloader-circle .circle-color", 2, { drawSVG: "100% 100%", ease: "expo.inOut", immediateRender: !1 }, 0), t.to("#preloader", 1, { autoAlpha: 0, ease: "none" }, 1), t.play(0);
}
...
function initButtons() {
    deviceSettings.isMobile
        ? ($("#begin-button").addEventListener("touchstart", hideIntro, !1),
          ...
          $("#toggle-rotation").addEventListener("touchstart", toggleRotation, !1))
        : ($("#begin-button").addEventListener("click", hideIntro, !1),
            ...
            if (!isGameOver) {
                ...
                (flightInput = t.keyCode + flightInput),
                    "50495353" === flightInput.substring(0, 8) &&
                        ...
                        gsap.to(translationVector, 5, { x: 0, y: 0, z: 0, ease: "circ.out" }),
                        gsap.to(camera.position, 5, { x: 0, y: 0, z: -149.5, ease: "circ.out" }),
                        gsap.to(camera.rotation, 5, { x: 0 * toRAD, y: 0 * toRAD, z: 0 * toRAD, ease: "circ.out" })),
        ...
        document.addEventListener("keyup", function (t) {
            if (!isGameOver) {
                ...
                e === o.rotate_left || e === o.rotate_left2
                    ...
                    : e === o.move_up
                    ? (translateUp(), $("#translate-up-button").classList.remove("active"))
                    : e === o.move_down
                    ? (translateDown(), $("#translate-down-button").classList.remove("active"))
                    : e === o.move_left
                    ? (translateLeft(), $("#translate-left-button").classList.remove("active"))
                    : e === o.move_right
                    ? (translateRight(), $("#translate-right-button").classList.remove("active"))
                    : e === o.forward
                    ? (translateForward(), $("#translate-forward-button").classList.remove("active"))
                    : e === o.backward
                    ? (translateBackward(), $("#translate-backward-button").classList.remove("active"))
                    : void 0;
            }
        });
}
...
function updatePrecision(t) {
    "rotation" === t &&
        ((rotationPulseSize = 0.5 === rotationPulseSize ? 1 : 0.5), $("#rotation-controls").classList.toggle("large"), $("#precision-rotation-status").classList.toggle("large"), $("#hud-tips").classList.toggle("rotation-large")),
        "translation" === t &&
...
function resetPrecision() {
    $("#rotation-controls").classList.contains("large") && updatePrecision("rotation"), $("#translation-controls").classList.contains("large") && updatePrecision("translation");
}
var introAnimationIn,
    introAnimationOut,
    interfaceAnimationIn,
    interfaceAnimationOut,
    isIntroStarted = !1;
function showIntro() {
    (introAnimationIn = new TimelineMax({ paused: !0 })),
        introAnimationIn.fromTo("#intro", 1, { autoAlpha: 0 }, { autoAlpha: 1, display: "block", ease: "none" }, 0),
        introAnimationIn.staggerFromTo("#logoSVG .stroke_white", 1, { stroke: "#000000" }, { stroke: "#FFFFFF", ease: "none" }, 0.1, 1),
        introAnimationIn.staggerFromTo("#logoSVG .stroke_white", 2, { drawSVG: "50% 50%" }, { drawSVG: "0% 100%", ease: "circ.inOut" }, 0.25, 1),
        introAnimationIn.fromTo("#logoSVG .fill", 2, { autoAlpha: 0 }, { autoAlpha: 1, ease: "none" }, 4),
        introAnimationIn.staggerFromTo("#intro-step1 .animate", 2, { y: 50, autoAlpha: 0 }, { y: 0, autoAlpha: 1, ease: "expo.out" }, 0.25, 4),
        introAnimationIn.play(0);
}
function showIntroHelpers() {
    gsap.set("#logoSVG, #intro-step1", { display: "none" }),
        gsap.set("#intro-step2", { autoAlpha: 1, display: "block" }),
        gsap.fromTo("#intro-step2 h2, #intro-step2 p, #intro-step2 .message-button", 2, { y: 50, autoAlpha: 0 }, { y: 0, autoAlpha: 1, ease: "expo.out", stagger: 0.25 });
}
function hideIntro() {
    isIntroStarted || ((isIntroStarted = !0), (introAnimationOut = new TimelineMax({ paused: !0 })), introAnimationOut.fromTo("#intro", 0.5, { autoAlpha: 1 }, { autoAlpha: 0, ease: "none" }, 0), introAnimationOut.play(0));
}
function showInterface() {
    (interfaceAnimationIn = new TimelineMax({
        ...
        interfaceAnimationIn.to("#fail, #success", 0.5, { autoAlpha: 0 }, 0),
        interfaceAnimationIn.fromTo(
            "#hud-darken, #iss_target, #navball, #helpers",
            3,
            { autoAlpha: 0 },
            {
                autoAlpha: 1,
                ease: "none",
                onStart: function () {
                    $("#rotation-controls").classList.remove("hidden"), $("#translation-controls").classList.remove("hidden");
                },
            },
            1
        ),
        ...
        interfaceAnimationIn.fromTo("#hud-ring-inner", 1.5, { rotation: -180 }, { rotation: 0, ease: "expo.out" }, 2),
        interfaceAnimationIn.fromTo("#hud-ring, #hud-ring-inner", 1.5, { autoAlpha: 0 }, { autoAlpha: 1, ease: "none" }, 2),
        interfaceAnimationIn.staggerFromTo("#hud .hud-item .error, #hud .hud-item .rate, #pyr .distance", 1, { autoAlpha: 0 }, { autoAlpha: 1, ease: "none" }, 0.1, 3),
        interfaceAnimationIn.fromTo("#range .label", 1, { scrambleText: { text: " " } }, { scrambleText: { text: "RANGE", chars: "0123456789!@#$%^&*()" }, ease: "none" }, 3),
        interfaceAnimationIn.fromTo("#rate .label", 1, { scrambleText: { text: " " } }, { scrambleText: { text: "RATE", chars: "0123456789!@#$%^&*()" }, ease: "none" }, 3),
        interfaceAnimationIn.fromTo("#roll-label", 1, { scrambleText: { text: " " } }, { scrambleText: { text: "ROLL", chars: "0123456789!@#$%^&*()" }, ease: "none" }, 3.25),
        interfaceAnimationIn.fromTo("#pitch-label", 1, { scrambleText: { text: " " } }, { scrambleText: { text: "PITCH", chars: "0123456789!@#$%^&*()" }, ease: "none" }, 3.25),
        interfaceAnimationIn.fromTo("#pyr-label", 1, { scrambleText: { text: " " } }, { scrambleText: { text: "XYZ", chars: "0123456789!@#$%^&*()" }, ease: "none" }, 3.25),
        interfaceAnimationIn.fromTo("#yaw-label", 1, { scrambleText: { text: " " } }, { scrambleText: { text: "YAW", chars: "0123456789!@#$%^&*()" }, ease: "none" }, 3.25),
        interfaceAnimationIn.fromTo("#options", 1, { autoAlpha: 0 }, { autoAlpha: 1, ease: "none" }, 3),
...
function hideInterface(t) {
    (isGameOver = !0),
        (interfaceAnimationOut = new TimelineMax({
            paused: !0,
            onStart: function () {
                $("#rotation-controls").classList.add("hidden"), $("#translation-controls").classList.add("hidden");
            },
        })),
        interfaceAnimationOut.to("#hud-darken", 0.5, { autoAlpha: 0, ease: Linear.easeOut }, 0),
        interfaceAnimationOut.to("#hud, #iss_target, #navball, #helpers", 1.5, { autoAlpha: 0, ease: Linear.easeOut }, 0),
        interfaceAnimationOut.to("#hud .hud-item .error, #hud .hud-item .rate, #pyr .distance", 0.5, { autoAlpha: 0, ease: "none" }, 0),
        interfaceAnimationOut.to("#range .label", 1.5, { scrambleText: { text: " ", chars: "0123456789!@#$%^&*()" }, ease: "none" }, 0),
        interfaceAnimationOut.to("#rate .label", 1.5, { scrambleText: { text: " ", chars: "0123456789!@#$%^&*()" }, ease: "none" }, 0),
        interfaceAnimationOut.to("#roll-label", 1.5, { scrambleText: { text: " ", chars: "0123456789!@#$%^&*()" }, ease: "none" }, 0),
        interfaceAnimationOut.to("#pitch-label", 1.5, { scrambleText: { text: " ", chars: "0123456789!@#$%^&*()" }, ease: "none" }, 0),
        interfaceAnimationOut.to("#pyr-label", 1.5, { scrambleText: { text: " ", chars: "0123456789!@#$%^&*()" }, ease: "none" }, 0),
        interfaceAnimationOut.to("#yaw-label", 1.5, { scrambleText: { text: " ", chars: "0123456789!@#$%^&*()" }, ease: "none" }, 0),
        ...
        "success" === t &&
            (interfaceAnimationOut.fromTo("#success", 1, { autoAlpha: 0 }, { autoAlpha: 1, display: "block" }, 2),
            interfaceAnimationOut.fromTo("#success h3", 2, { scrambleText: { text: " " } }, { scrambleText: { text: "SUCCESS", chars: "0123456789!@#$%^&*()" }, ease: "none" }, 2),
            interfaceAnimationOut.fromTo("#success-button", 1, { y: 50, autoAlpha: 0 }, { y: 0, autoAlpha: 1, ease: "expo.out" }, 3)),
        "fail" === t &&
            (interfaceAnimationOut.fromTo("#fail", 1.5, { autoAlpha: 0 }, { autoAlpha: 1, display: "block" }, 2),
            interfaceAnimationOut.fromTo("#fail h3", 1.5, { scrambleText: { text: " " } }, { scrambleText: { text: "GAME OVER", chars: "0123456789!@#$%^&*()" }, ease: "none" }, 2),
            interfaceAnimationOut.fromTo("#fail-button", 1, { y: 50, autoAlpha: 0 }, { y: 0, autoAlpha: 1, ease: "expo.out" }, 3)),
        interfaceAnimationOut.to("#options", 1, { autoAlpha: 0, ease: "none" }, 0),
        interfaceAnimationOut.play(1),
        resetMovement();
}
function resetMovement() {
    (rateRotationX = 0),
        ...
        gsap.to("#worm-roll, #worm-pitch, #worm-yaw", 2, { drawSVG: "50% 50%", ease: "expo.out" }),
        resetPrecision();
}
...
function enviarDone(done,reward) {
    console.log(done)
    if (done_received) {
        socket.emit('done_data',[done,reward]);
    }
    done_received = 0;
}

socket.on('blablabla',function(data)  {
    // console.log('received_done')
    done_received = 1;
});

socket.on('datos_hacia_cliente', function(data) {
...
var lightObject,
    ...
    lightBurstHelper,
    lightColorAnimation,
    lightColor = new THREE.Color(13434879),
    lightColor1 = new THREE.Color(16766097),
    lightColor2 = new THREE.Color(6657945),
    lightColor3 = new THREE.Color(16766097),
    lightColorWhite = new THREE.Color(16777215),
    lightColorArray = [],
    lightsCreated = !1;
function createLights() {
    (lightObject = new THREE.Object3D()),
        ...
        (lightCamera = new THREE.PointLight(lightColorWhite, 0.25, 5, 2)),
        camera.add(lightCamera),
        (lightColorArray = [lightFar.color, lightClose.color, lightBurst.color]),
        (lightColorAnimation = new TimelineMax({ paused: !0, repeat: -1 })),
        lightColorAnimation.to(lightColorArray, 2, { r: lightColor1.r, g: lightColor1.g, b: lightColor1.b }, 0),
        lightColorAnimation.to(lightColorArray, 2, { r: lightColor2.r, g: lightColor2.g, b: lightColor2.b }, 2),
        lightColorAnimation.to(lightColorArray, 2, { r: lightColor3.r, g: lightColor3.g, b: lightColor3.b }, 4),
        lightColorAnimation.to(lightColorArray, 2, { r: lightColorWhite.r, g: lightColorWhite.g, b: lightColorWhite.b }, 6),
        lightColorAnimation.to(lightColorArray, 2, { r: lightColor1.r, g: lightColor1.g, b: lightColor1.b }, 8),
        lightColorAnimation.timeScale(2),
        (lightsCreated = !0);
}
var lightVars = { velocity: 0, intensity: 0, color: 75 };
function renderLights() {
    lightsCreated &&
        (warpVars.isFinished ||
            (isIntroStarted
                ? !warpVars.isTriggered && (gsap.to(lightVars, 1, { velocity: 12, intensity: 10 }), lightColorAnimation.play())
                : warpVars.isTriggered && (gsap.to(lightVars, 3, { velocity: 0, intensity: 0 }), lightColorAnimation.pause())),
...
var warpObject,
    ...
    wormholeMaterial,
    wormholeMesh,
    warpVars = { isTriggered: !1, isFinished: !1, distanceSpeed: 0.1, distanceCurrent: 5e5 },
    isWarpComplete = !1,
    wormholeVars = { opacity: 0, textureSpeed: 0, rotationSpeed: 0 },
    wormholeCreated = !1;
function createWormhole() {
    (warpObject = new THREE.Group()),
        ...
        (wormholeMaterial = new THREE.MeshLambertMaterial({ color: 16777215, opacity: 0, map: wormholeTexture, blending: THREE.AdditiveBlending, side: THREE.BackSide, transparent: !0, depthTest: !1 })),
        ...
        (warpVars.isFinished ||
            (isIntroStarted
                ? !warpVars.isTriggered &&
                  ...
                  gsap.to(wormholeVars, 1, { textureSpeed: 5, rotationSpeed: 25 }),
                  gsap.to(wormholeObject.scale, 1, { z: 3, ease: "expo.inOut" }))
                : warpVars.isTriggered && (gsap.to(wormholeVars, 2, { opacity: 0 }), gsap.to(wormholeVars, 2, { textureSpeed: 0, rotationSpeed: 0 }), gsap.to(wormholeObject.scale, 1.25, { z: 1 }))),
        0 >= wormholeVars.opacity
            ? wormholeObject.visible && (wormholeObject.visible = !1)
            : ((wormholeMaterial.opacity = wormholeVars.opacity), (wormholeObject.rotation.z -= 0.001 * wormholeVars.rotationSpeed), (wormholeTexture.offset.y -= 0.001 * wormholeVars.textureSpeed), (wormholeMaterial.needsUpdate = !0)));
}
var tunnelObject,
    tunnelTexture,
    tunnelGeometry,
    tunnelMaterial,
    tunnelMesh,
    tunnelVars = { opacity: 0, textureSpeed: 0.1, rotationSpeed: 1 },
    tunnelCreated = !1;
function createTunnel() {
    (tunnelObject = new THREE.Object3D()),
        ...
        (tunnelMaterial = new THREE.MeshLambertMaterial({ color: 16777215, opacity: 0, map: tunnelTexture, blending: THREE.AdditiveBlending, side: THREE.BackSide, transparent: !0, depthTest: !0 })),
        ...
        (warpVars.isFinished ||
            (isIntroStarted
                ? !warpVars.isTriggered &&
                  ...
                  gsap.to(tunnelVars, 1, { textureSpeed: 5, rotationSpeed: 45 }))
                : warpVars.isTriggered && (gsap.to(tunnelVars, 2, { opacity: 0 }), gsap.to(tunnelVars, 2, { textureSpeed: 0.1, rotationSpeed: 1 }))),
        0 >= tunnelVars.opacity
            ? tunnelObject.visible && (tunnelObject.visible = !1)
            : ((tunnelMaterial.opacity = tunnelVars.opacity), (tunnelObject.rotation.z -= 0.001 * tunnelVars.rotationSpeed), (tunnelTexture.offset.y -= 0.001 * tunnelVars.textureSpeed), (tunnelMaterial.needsUpdate = !0)));
}
var sonicObject,
    sonicTexture,
    sonicGeometry,
    sonicMaterial,
    sonicMesh,
    sonicVars = { opacity: 0, textureSpeed: 0, rotationSpeed: 0, textureRepeat: 1 },
    sonicAnimation = new TimelineMax({ paused: !0 }),
    sonicCreated = !1;
function createSonic() {
    (sonicObject = new THREE.Object3D()),
        ...
        (sonicMaterial = new THREE.MeshLambertMaterial({ color: 16777215, map: sonicTexture, blending: THREE.AdditiveBlending, side: THREE.BackSide, transparent: !0, depthTest: !0 })),
        ...
        (warpVars.isFinished ||
            (isIntroStarted
                ? !warpVars.isTriggered &&
                  ...
                  gsap.to(sonicVars, 4, { textureSpeed: 30, rotationSpeed: 45, textureRepeat: 2 }))
                : warpVars.isTriggered && (gsap.to(sonicVars, 1, { opacity: 0 }), gsap.to(sonicVars, 1, { textureSpeed: 0, rotationSpeed: 0, textureRepeat: 1 }))),
        0 >= sonicVars.opacity
            ? sonicObject.visible && (sonicObject.visible = !1)
            : ((sonicMaterial.opacity = sonicVars.opacity),
              sonicTexture.repeat.set(1, sonicVars.textureRepeat),
              (sonicObject.rotation.z -= 0.001 * sonicVars.rotationSpeed),
              (sonicTexture.offset.y -= 0.001 * sonicVars.textureSpeed),
              (sonicMaterial.needsUpdate = !0)));
}
var starfieldObject,
    starfieldTexture,
    starfieldMaterial,
    starfieldMaterialBlue,
    starfieldMaterialOrange,
    starfieldMaterialWhite,
    starfieldColorTotal,
    starfieldTotal = 500,
    starfieldScaleFactor = 1,
    starfieldStartZ = -450,
    starfieldEndZ = 50,
    starfieldMaxDistance = 250,
    starfieldMaxDistanceZ = 500,
    starBuffer = 15,
    starfieldSpritesArray = [],
    starfieldObjectsArray = [],
    starfieldDetailsArray = [],
    starfieldColorBase = new THREE.Color(16766097),
    starfieldColorBlue = new THREE.Color(6657945),
    starfieldColorOrange = new THREE.Color(16766097),
    starfieldColorWhite = new THREE.Color(16777215),
    starfieldColorHyper = new THREE.Color(16777215),
    starfieldMaterialArray = [],
    starfieldMaterialColorArray = [],
    starfieldVars = { velocity: 0.1, scale: 1, stretch: 1, rotation: -90, lookat: 0 },
    starfieldCreated = !1;
function createStarfield() {
    for (
        starfieldObject = new THREE.Group(),
            starfieldMaterialBlue = new THREE.MeshBasicMaterial({ map: starfieldTexture, opacity: 1, color: starfieldColorBlue, transparent: !0, blending: THREE.AdditiveBlending, side: THREE.DoubleSide, depthWrite: !1 }),
            starfieldMaterialOrange = new THREE.MeshBasicMaterial({ map: starfieldTexture, opacity: 1, color: starfieldColorOrange, transparent: !0, blending: THREE.AdditiveBlending, side: THREE.DoubleSide, depthWrite: !1 }),
            starfieldMaterialWhite = new THREE.MeshBasicMaterial({ map: starfieldTexture, opacity: 1, color: starfieldColorWhite, transparent: !0, blending: THREE.AdditiveBlending, side: THREE.DoubleSide, depthWrite: !1 }),
            ...
            deviceSettings.isMobile && ((starfieldTotal = Math.floor(starfieldTotal / 3)), (starfieldScaleFactor = 1)),
            i = 0;
        i < starfieldTotal;
        i++
    ) {
        ...
        r.add(a), (a.rotation.x = 90 * toRAD), starfieldObjectsArray.push(r), starfieldSpritesArray.push(a), starfieldObject.add(r), r.position.set(t.x, t.y, t.z), (r.up = new THREE.Vector3(0, 0, 1)), r.lookAt(new THREE.Vector3(0, 0, t.z));
        var n = a.rotation.x,
            s = a.rotation.y,
            l = a.rotation.z,
            d = 0.01 * (100 * Math.random()) + starfieldScaleFactor;
        a.scale.set(d, d, d);
    ...
    warpObject.add(starfieldObject), renderer.compile(scene, camera), (starfieldCreated = !0);
}
function renderStarfield() {
    if (starfieldCreated) {
        warpVars.isFinished ||
            (isIntroStarted
                ? !warpVars.isTriggered &&
                  (gsap.to(starfieldVars, 1, { velocity: 15 }),
                  gsap.to(starfieldVars, 1, { scale: 1, stretch: 25 }),
                  gsap.to(starfieldVars, 0.5, { rotation: 0 }),
                  gsap.to(starfieldMaterialColorArray, 2, { r: starfieldColorHyper.r, g: starfieldColorHyper.g, b: starfieldColorHyper.b }))
                : warpVars.isTriggered &&
                  (gsap.to(starfieldVars, 3, { velocity: 0.05 }),
                  gsap.to(starfieldVars, 0.5, { scale: 1, stretch: 1 }),
                  gsap.to(starfieldVars, 0.5, { rotation: -90 }),
                  gsap.to(starfieldMaterialBlue.color, 2, { r: starfieldColorBlue.r, g: starfieldColorBlue.g, b: starfieldColorBlue.b }),
                  gsap.to(starfieldMaterialOrange.color, 2, { r: starfieldColorOrange.r, g: starfieldColorOrange.g, b: starfieldColorOrange.b }),
                  gsap.to(starfieldMaterialWhite.color, 2, { r: starfieldColorWhite.r, g: starfieldColorWhite.g, b: starfieldColorWhite.b })));
...
function updateDistance() {
    warpVars.isFinished ||
        (isIntroStarted ? !warpVars.isTriggered && ((warpVars.isTriggered = !0), gsap.to(warpVars, 1, { distanceSpeed: 5512 })) : warpVars.isTriggered && ((warpVars.isTriggered = !1), gsap.to(warpVars, 1, { distanceSpeed: 0.1 })),
        (warpVars.distanceCurrent -= warpVars.distanceSpeed),
        0 >= warpVars.distanceCurrent && ((warpVars.isFinished = !0), (warpVars.distanceCurrent = 0), finishWarp()));
}
...
function finishWarp() {
    for (
        isWarpComplete = !0,
            gsap.to([sonicVars, tunnelVars, wormholeVars], 1, { opacity: 0 }),
            gsap.to([sonicVars, tunnelVars, wormholeVars], 3, { textureSpeed: 0, rotationSpeed: 0 }),
            gsap.to(lightVars, 3, { velocity: 0, intensity: 0 }),
            gsap.to(starfieldVars, 3, { scale: 1, stretch: 1, velocity: 0 }),
            gsap.to(starfieldMaterialBlue.color, 2, { r: starfieldColorBlue.r, g: starfieldColorBlue.g, b: starfieldColorBlue.b }),
            gsap.to(starfieldMaterialOrange.color, 2, { r: starfieldColorOrange.r, g: starfieldColorOrange.g, b: starfieldColorOrange.b }),
            gsap.to(starfieldMaterialWhite.color, 2, { r: starfieldColorWhite.r, g: starfieldColorWhite.g, b: starfieldColorWhite.b }),
            ...
            gsap.to(lightISS_Primary, 2, { intensity: 0.75, ease: "none" }),
            gsap.to(lightISS_Secondary, 2, { intensity: 1, ease: "none" }),
            gsap.to([lightISS_Top, lightISS_Bottom], 2, { intensity: 0.5, ease: "none" }),
            ...
            gsap.fromTo(issObject.position, 3, { z: -1e3 }, { z: -150, ease: "expo.out" }),
            ...
            i = 0;
        i < orbSpriteArray.length;
        i++
    )
        gsap.to(orbSpriteArray[i].scale, 3, { x: orbSpriteSize, y: orbSpriteSize, z: orbSpriteSize, ease: "expo.out", delay: 0.5 });
    ...
    (e.onUpdate = function () {
        ...
        gsap.to(t, 3, e),
        gsap.fromTo(orbObject.position, 3, { z: -50 }, { z: 0, ease: "expo.out" }),
        showInterface();
}
var universeBgTexture,
    universeBgMaterial,
    universeBgGeometry,
    universeBgMesh,
    universeCreated = !1;
function createUniverse() {
    (universeBgGeometry = new THREE.SphereGeometry(3e7, 32, 32)),
        (universeBgMaterial = new THREE.MeshBasicMaterial({ map: universeBgTexture, transparent: !0, opacity: 0, side: THREE.BackSide })),
...
var starsObject,
    ...
    starScaleFactor = 1,
    starMaterialArray = [],
    starMaterialColorArray = [],
    starsCreated = !1;
function createStars() {
    for (
        starsObject = new THREE.Group(),
            starsObject.visible = !1,
            scene.add(starsObject),
            starMaterialBlue = new THREE.MeshBasicMaterial({ map: starfieldTexture, color: starfieldColorBlue, opacity: 0, transparent: !0, blending: THREE.AdditiveBlending, depthWrite: !1, depthTest: !0 }),
            starMaterialOrange = new THREE.MeshBasicMaterial({ map: starfieldTexture, color: starfieldColorOrange, transparent: !0, opacity: 0, blending: THREE.AdditiveBlending, depthWrite: !1, depthTest: !0 }),
            starMaterialWhite = new THREE.MeshBasicMaterial({ map: starfieldTexture, color: starfieldColorWhite, transparent: !0, opacity: 0, blending: THREE.AdditiveBlending, depthWrite: !1, depthTest: !0 }),
            ...
            deviceSettings.isMobile && ((starTotal = Math.floor(starTotal / 3)), (starScaleFactor = 1.5)),
            i = 0;
        i < starTotal;
        i++
    ) {
        ...
        (t.x = 0 + starDistance * Math.sin(o) * Math.cos(e)), (t.y = 0 + starDistance * Math.sin(o) * Math.sin(e)), (t.z = 0 + starDistance * Math.cos(o));
        var a = new THREE.PlaneBufferGeometry(1, 1, 1),
            r = starMaterialArray[generateRandomNumber(0, starColorTotal)],
            n = new THREE.Mesh(a, r);
        n.position.set(t.x, t.y, t.z), n.lookAt(new THREE.Vector3(0, 0, 0));
        var s = 1e3 * generateRandomNumber(100, 350) * starScaleFactor;
        i > 0.25 * starTotal && (s = 2e5), n.scale.set(s, s, s), starsObject.add(n);
    }
    starsCreated = !0;
}
var earthObject,
    ...
    isFlatEarth = !1,
    isEarthCreated = !1,
    isFlatEarthCreated = !1;
function createEarth() {
    (earthObject = new THREE.Object3D()),
        scene.add(earthObject),
        (earthMesh = new THREE.Mesh(new THREE.SphereGeometry(6371, 64, 64), new THREE.MeshPhongMaterial({ map: earthTexture, shininess: 0 }))),
        (earthMesh.material.anisotropy = renderer.capabilities.getMaxAnisotropy()),
        earthObject.add(earthMesh);
    (earthObject.position.y = -1000 * (450 + 6371)), (earthObject.rotation.z = 51 * toRAD), earthObject.scale.set(1000, 1000, 1000), renderer.compile(scene, camera), (isEarthCreated = !0);
}
function createFlatEarth() {
    (flatEarthObject = new THREE.Object3D()),
        ...
        (flatEarthMesh = new THREE.Mesh(new THREE.PlaneGeometry(2048, 2048, 32), new THREE.MeshPhongMaterial({ map: flatEarthTexture, transparent: !0 }))),
        flatEarthObject.add(flatEarthMesh),
        (isFlatEarthCreated = !0);
}
function renderEarth() {
    isFlatEarth && (flatEarthMesh.rotation.z = flatEarthMesh.rotation.z += 0.05 * toRAD);
}
function createSheetMaterial(t, e) {
    var o = { map: { type: "t", value: e }, u_opacity: { type: "t", value: 1 }, u_uvRect: { type: "v4", value: new THREE.Vector4(t.x / 2048, t.y / 2048, t.w / 2048, t.h / 2048) } };
...
function createOrb() {
    ...
    for (let o of Object.keys(a)) {
        let r = a[o],
            i = r.frame;
        if (((i.name = o), -1 < o.indexOf("arrows/") && orbArrowArray.push(i), -1 < o.indexOf("brackets/") && orbBracketArray.push(i), -1 < o.indexOf("numbers/num-pos-"))) {
            if ("numbers/num-pos-180.png" === o) continue;
            t.push(i);
        }
        if (-1 < o.indexOf("numbers/num-neg-")) {
            if ("numbers/num-neg-180.png" === o) continue;
            e.push(i);
        }
    }
    var r = getFrame("numbers/num-end-yaw.png", forwardViewSpriteJson);
    e.push(r), (e = e.reverse()), (orbNumberArray = t.concat(e));
    var n = new THREE.PlaneGeometry(1, 1, 1, 1);
    for (i = 0; i < orbTotal; i++)
        if (0 != i % 2) {
            var s = new THREE.Vector3();
            (s.x = orbRadius * Math.cos(orbAngle * i)), (s.y = 0), (s.z = orbRadius * Math.sin(orbAngle * i)), s.applyAxisAngle(new THREE.Vector3(0, 1, 0), 90 * toRAD);
            var l;
            (l =
                90 > i
                    ? 10 >= i
                        ? createSheetMaterial(orbArrowArray[i + 9], forwardViewSpriteTexture)
                        : createSheetMaterial(orbArrowArray[19], forwardViewSpriteTexture)
                    : 171 <= i
                    ? createSheetMaterial(orbArrowArray[179 - i], forwardViewSpriteTexture)
                    : createSheetMaterial(orbArrowArray[9], forwardViewSpriteTexture)),
                (l.needsUpdate = !0);
            var d = new THREE.Mesh(n, l);
            d.position.set(s.x, s.y, s.z), d.scale.set(orbSpriteSize, orbSpriteSize, orbSpriteSize), d.scale.set(0.01, 0.01, 0.01), d.lookAt(new THREE.Vector3(0, 0, 0)), orbSpriteArray.push(d), orbYawObject.add(d);
            var s = new THREE.Vector3();
            (s.x = 0), (s.y = orbRadius * Math.cos(orbAngle * i)), (s.z = orbRadius * Math.sin(orbAngle * i)), s.applyAxisAngle(new THREE.Vector3(1, 0, 0), -90 * toRAD);
            var l;
            (l =
                90 > i
                    ? 10 >= i
                        ? createSheetMaterial(orbBracketArray[i + 9], forwardViewSpriteTexture)
                        : createSheetMaterial(orbBracketArray[19], forwardViewSpriteTexture)
                    : 171 <= i
                    ? createSheetMaterial(orbBracketArray[179 - i], forwardViewSpriteTexture)
                    : createSheetMaterial(orbBracketArray[9], forwardViewSpriteTexture)),
                (l.needsUpdate = !0);
    ...
    for (i = 0; i < orbTotal; i++)
        if (0 == i % 2) {
            ...
            if (0 === i) {
                ...
                l = createSheetMaterial(c, forwardViewSpriteTexture);
            } else l = createSheetMaterial(orbNumberArray[i], forwardViewSpriteTexture);
            var u = new THREE.Mesh(n, l);
            u.position.set(s.x, s.y, s.z), u.scale.set(orbSpriteSize, orbSpriteSize, orbSpriteSize), u.scale.set(0.01, 0.01, 0.01), u.lookAt(new THREE.Vector3(0, 0, 0)), orbSpriteArray.push(u), orbYawObject.add(u);
            var s = new THREE.Vector3();
            (s.x = 0), (s.y = orbRadius * Math.cos(orbAngle * i)), (s.z = orbRadius * Math.sin(orbAngle * i)), s.applyAxisAngle(new THREE.Vector3(1, 0, 0), -90 * toRAD);
            var l;
            if (0 === i) {
            ...
            var u = new THREE.Mesh(n, l);
            u.position.set(s.x, s.y, s.z), u.scale.set(orbSpriteSize, orbSpriteSize, orbSpriteSize), u.scale.set(0.01, 0.01, 0.01), u.lookAt(new THREE.Vector3(0, 0, 0)), orbSpriteArray.push(u), orbPitchObject.add(u);
        }
    (orbFadeTarget = new THREE.Mesh(n, new THREE.MeshBasicMaterial({}))), orbFadeTarget.position.set(0, 0, -15), (orbFadeTarget.rotation.x = 90 * toRAD), orbObject.add(orbFadeTarget), createRings(), (isOrbCreated = !0);
}
var orbRingObject,
    orbRingBufferGeometry,
    orbRingShaderMaterial,
    orbRingMesh1,
    orbRingMesh2,
    orbRingMesh3,
    orbRingMesh4,
    orbRingLineTotal = 250,
    orbRingAngle = (2 * Math.PI) / 250,
    orbRingVerticesArray = [],
    orbRingMaxOpacity = 0.25,
    orbRingOpacityArray = [];
function createRings() {
    for (orbRingObject = new THREE.Object3D(), orbRollObject.add(orbRingObject), r = 0; r < orbRingLineTotal; r++) {
        var t = new THREE.Vector3();
        (t.x = orbRadius * Math.cos(orbRingAngle * r)), (t.y = 0), (t.z = orbRadius * Math.sin(orbRingAngle * r)), t.applyAxisAngle(new THREE.Vector3(0, 1, 0), 90 * toRAD), orbRingVerticesArray.push(t);
    }
    (orbRingBufferGeometry = new THREE.BufferGeometry()),
        (orbRingShaderUniforms = { color: { value: new THREE.Color(16777215) }, fogColor: { type: "c", value: scene.fog.color }, fogNear: { type: "f", value: scene.fog.near }, fogFar: { type: "f", value: scene.fog.far } }),
    ...
    for (var e = orbFadeTarget.getWorldPosition(new THREE.Vector3()), o = new Float32Array(3 * orbRingVerticesArray.length), a = new Float32Array(orbRingVerticesArray.length), r = 0; r < orbRingVerticesArray.length; r++) {
        (o[3 * r] = orbRingVerticesArray[r].x), (o[3 * r + 1] = orbRingVerticesArray[r].y), (o[3 * r + 2] = orbRingVerticesArray[r].z);
        var n = orbRingVerticesArray[r],
            s = Math.abs(n.distanceTo(e)),
            l = opacityDistanceClamp(s, 5, 1, orbRingMaxOpacity);
        orbRingOpacityArray.push(l), (a[r] = 0);
    }
...
function opacityDistanceClamp(t, e, o, a) {
    var r = a;
    return t < e && (t > o ? (r = ((t - o) / (e - o)) * a) : (r = 0)), r;
}
...
function renderOrb() {
    if (isOrbCreated) {
        (orbYawObject.rotation.y = -camera.rotation.y), (orbPitchObject.rotation.x = -camera.rotation.x), (orbRollObject.rotation.z = -camera.rotation.z);
...
function createIss() {
    (issObject = new THREE.Object3D()),
        ...
        issObject.scale.set(0.001, 0.001, 0.001),
        scene.add(issObject),
        ...
        issLoader.load(
            ...
            function (t) {
                function e(t, e) {
                    var o = new THREE.Mesh(new THREE.TorusGeometry(10, 0.3, 5, 6), new THREE.MeshBasicMaterial({ color: 2413309, transparent: !0, opacity: e, side: THREE.DoubleSide }));
                    return o.scale.set(t, t, t), o;
                }
                t.scene.traverse(function (t) {
                    ...
                    (isIssLoaded = !0);
                var o = e(1, 0.15);
                (o.position.z = 20), issObject.add(o);
                var a = e(2, 0.2);
                (a.position.z = 40), issObject.add(a);
                var r = e(4, 0.25);
                (r.position.z = 80), issObject.add(r);
                var i = document.createElement("div");
                (i.className = "label"), (i.id = "iss_target");
...
function createTesla() {
    ...
    t.load(
        "tesla.glb",
        function (t) {
            (teslaMesh = t.scene), teslaMesh.position.set(12, 42, 80), (teslaMesh.rotation.y = 90 * toRAD), (teslaMesh.visible = !1), scene.add(teslaMesh), hitArray.push(teslaMesh);
            var e = new THREE.PointLight(lightColorWhite, 1, 5);
            e.position.set(12, 44, 78), scene.add(e), (isTeslaLoaded = !0);
        },
        function () {}
    ),
        (isTeslaCreated = !0);
...
function renderTesla() {
    2.5 < camera.rotation.y || -2.5 > camera.rotation.y ? (!isTeslaCreated && createTesla(), isTeslaLoaded && (teslaMesh.visible = !0)) : isTeslaLoaded && (teslaMesh.visible = !1);
}
var navballRotationObject,
    navballPerspectiveObject,
    navballObject,
    navballGeometry,
    navballMaterial,
    navballTexture,
    ...
    navballMarkerObject,
    navballLights,
    navballLightsGlowBottom,
    navballLightsParticle,
    navballRadius = 5,
    navballLightsColor = new THREE.Color("#FFFFFF"),
    navballLightsIntensity = 1.5,
    navballLightsDistance = 400,
    navballLightsDecay = 1,
    navballCreated = !1;
function createNavball() {
    (navballRotationObject = new THREE.Group()),
        ...
        (navballMaterial = new THREE.MeshPhongMaterial({ map: navballTexture })),
...
var prevRange,
    ...
    translationVector = new THREE.Vector3(0, 0, 0),
    gravity = 1e-4,
    rangeRateCounter = 0,
    smoothRangeRate = 0,
...
function render() {
    // if ((Date.now()-episode_init_time) * 1e-3 > episode_total_time) {
    //     console.log("timeout"),
    //     enviarDone(-1,-1000);
    //     console.log("4");
    // } else {
    ...
    // }
    // if(is_stopped == 1) {
    //     enviarMensaje(send_a,send_r,send_i,send_fixRotZ,send_fixRotX,send_fixRotY,send_dt);
    // }
    // else {
        if ((scene.updateMatrixWorld(), isWarpComplete)) {
            (currentRotationX = currentRotationX += (0.01 * -targetRotationX - currentRotationX) * moveSpeed),
                ...
                (fixedRotationX = (camera.rotation.x / toRAD).toFixed(5)),
                (fixedRotationY = (camera.rotation.y / toRAD).toFixed(5)),
                (fixedRotationZ = (camera.rotation.z / toRAD).toFixed(5)),
                ($("#pitch .error").innerHTML = fixedRotationX + "\xB0"),
                ($("#yaw .error").innerHTML = fixedRotationY + "\xB0"),
                ($("#roll .error").innerHTML = fixedRotationZ + "\xB0");
            var t = 0.1 * rateRotationX,
                e = 0.1 * rateRotationY,
                o = 0.1 * rateRotationZ;
            ($("#pitch .rate").innerHTML = t.toFixed(5) + " \xB0/s"), ($("#yaw .rate").innerHTML = e.toFixed(5) + " \xB0/s"), ($("#roll .rate").innerHTML = o.toFixed(5) + " \xB0/s");
            ...
            ($("#x-range .distance").innerHTML = a.toFixed(5) + " m"), ($("#y-range .distance").innerHTML = r.toFixed(5) + " m"), ($("#z-range .distance").innerHTML = i.toFixed(5) + " m");
            var n = Math.sqrt(a * a + r * r + i * i);
            var s = Date.now();
            // console.log(s,continue_time,stop_time,prevRangeTime);
            // var dt = (s - continue_time);// + (stop_time - prevRangeTime);
            var dt = s - prevRangeTime;
            if ((($("#range .rate").innerHTML = n.toFixed(5) + " m"), (rangeRateCounter += 1), 20 <= rangeRateCounter)) {
                rangeRateCounter = 0;
                (rateCurrent = 0.75 * (1e3 * ((n - prevRange) / dt))),
                    (smoothRangeRate += (rateCurrent - smoothRangeRate) / rateSmoothingFactor),
                    ($("#rate .rate").innerHTML = rateCurrent.toFixed(5) + " m/s"),
                    (prevRange = n),
                    (prevRangeTime = s);
            }
            (prevRange = n), (prevRangeTime = s), earthMesh.rotateY(1e-4);
...
function translateForward() {
    !0 === isGameOver ||
        ...
        gsap.fromTo(
            ...
            2,
            { y: 250, scale: 1, autoAlpha: 1 },
            { y: 100, scale: 0.25, autoAlpha: 0, ease: "expo.out" }
        ));
}
function translateBackward() {
    !0 === isGameOver ||
        ...
        motionVector.add(translationVector),
        gsap.fromTo(
            "#tip-translate-backward-up .arrow, #tip-translate-backward-right .arrow, #tip-translate-backward-down .arrow, #tip-translate-backward-left .arrow",
            2,
            { y: 100, scaleX: 0, scaleY: 0 },
            { y: 250, scaleX: 1, scaleY: 1, ease: "expo.out" }
        ),
        gsap.fromTo("#tip-translate-backward-up .arrow, #tip-translate-backward-right .arrow, #tip-translate-backward-down .arrow, #tip-translate-backward-left .arrow", 3, { autoAlpha: 1 }, { autoAlpha: 0, ease: "expo.out" }));
}
function translateDown() {
    !0 === isGameOver ||
        ...
        gsap.fromTo("#tip-translatey-pos .arrow2", 2, { x: -5, scale: 1, autoAlpha: 1 }, { x: -100, scale: 0.5, autoAlpha: 0, ease: "expo.out" }),
        gsap.fromTo("#tip-translatey-pos .arrow3", 2, { x: -10, scale: 1, autoAlpha: 1 }, { x: -150, scale: 0.25, autoAlpha: 0, ease: "expo.out" }));
}
function translateUp() {
    !0 === isGameOver ||
        ...
        gsap.fromTo("#tip-translatey-neg .arrow2", 2, { x: -5, scale: 1, autoAlpha: 1 }, { x: -100, scale: 0.5, autoAlpha: 0, ease: "expo.out" }),
        gsap.fromTo("#tip-translatey-neg .arrow3", 2, { x: -10, scale: 1, autoAlpha: 1 }, { x: -150, scale: 0.25, autoAlpha: 0, ease: "expo.out" }));
}
function translateRight() {
    !0 === isGameOver ||
        ...
        gsap.fromTo("#tip-translatex-pos .arrow2", 2, { x: -5, scale: 1, autoAlpha: 1 }, { x: -100, scale: 0.5, autoAlpha: 0, ease: "expo.out" }),
        gsap.fromTo("#tip-translatex-pos .arrow3", 2, { x: -10, scale: 1, autoAlpha: 1 }, { x: -150, scale: 0.25, autoAlpha: 0, ease: "expo.out" }));
}
function translateLeft() {
    !0 === isGameOver ||
        ...
        gsap.fromTo("#tip-translatex-neg .arrow2", 2, { x: -5, scale: 1, autoAlpha: 1 }, { x: -100, scale: 0.5, autoAlpha: 0, ease: "expo.out" }),
        gsap.fromTo("#tip-translatex-neg .arrow3", 2, { x: -10, scale: 1, autoAlpha: 1 }, { x: -150, scale: 0.25, autoAlpha: 0, ease: "expo.out" }));
}
var wormRate = 0,
    wormRateCaution = 5,
    wormRateWarning = 7,
...
function updateWorm(t) {
    var e;
    "roll" === t
        ? ((wormRate = updateWormRate(rateRotationZ)),
          updateWormRateColor(rateRotationZ, "roll"),
          0 > rateRotationZ ? (e = 48 + wormRate + "% " + wormPercentageBase + "%") : 0 === rateRotationZ ? (e = "48.5% 51.5%") : 0 < rateRotationZ && (e = "50% " + (52 + wormRate) + "%"))
        : "pitch" === t
        ? ((wormRate = updateWormRate(rateRotationX)),
          updateWormRateColor(rateRotationX, "pitch"),
          0 > rateRotationX ? (e = 48 + wormRate + "% " + wormPercentageBase + "%") : 0 === rateRotationX ? (e = "48.5% 51.5%") : 0 < rateRotationX && (e = "50% " + (52 + wormRate) + "%"))
        : "yaw" === t
        ? ((wormRate = updateWormRate(rateRotationY)),
          updateWormRateColor(rateRotationY, "yaw"),
          0 > rateRotationY ? (e = "50% " + (52 - wormRate) + "%") : 0 === rateRotationY ? (e = "48.5% 51.5%") : 0 < rateRotationY && (e = 48 - wormRate + "% " + wormPercentageBase + "%"))
        : void 0;
    gsap.to("#worm-" + t, 1, { drawSVG: e, ease: "expo.out" });
}
function updateWormRate(t) {
    return t <= -wormRateClamp ? (t = -wormRateClamp) : t >= wormRateClamp && (t = wormRateClamp), t;
}
    ...
    $("#worm-" + e).classList.remove("caution"),
        ...
        o < wormRateCaution ||
            (o >= wormRateCaution && o < wormRateWarning
                ? ($("#worm-" + e).classList.add("caution"), $("#" + e + " .rate").classList.add("caution"))
                : o >= wormRateWarning && ($("#worm-" + e).classList.add("warning"), $("#" + e + " .rate").classList.add("warning")));
}
var rateCategory = "";
function updateRateColor(t) {
    if (t !== rateCategory) {
        var e = $("#rate .rate");
        e.classList.remove("caution"), e.classList.remove("warning"), "caution" == t && e.classList.add("caution"), "warning" === t && e.classList.add("warning");
    }
}
var instructionsStep = 1,
    instructionsTotal = 7;
function instructionsOpen() {
    gsap.fromTo("#instructions", 0.25, { autoAlpha: 0 }, { autoAlpha: 1, display: "block", ease: "none" }),
        gsap.fromTo("#instructions .modal-close", 1, { rotation: -90, autoAlpha: 0 }, { rotation: 0, autoAlpha: 1, ease: Expo.easeOut }),
        gsap.fromTo("#instructions #arrow-prev", 1, { x: 25, autoAlpha: 0 }, { x: 0, autoAlpha: 1, ease: Expo.easeOut }),
        gsap.fromTo("#instructions #arrow-next", 1, { x: -25, autoAlpha: 0 }, { x: 0, autoAlpha: 1, ease: Expo.easeOut }),
        instructionsChange();
}
function instructionsClose() {
    (instructionsStep = 1), gsap.fromTo("#instructions", 0.25, { autoAlpha: 1 }, { autoAlpha: 0, ease: "none" });
}
function instructionsPrevious() {
    instructionsStep--, 1 > instructionsStep && (instructionsStep = instructionsTotal), instructionsChange();
}
function instructionsNext() {
    instructionsStep++, instructionsStep > instructionsTotal && (instructionsStep = 1), instructionsChange();
}
function instructionsChange() {
    var t = "#instruction" + instructionsStep;
    gsap.set(".instruction-item", { autoAlpha: 0, display: "none" }),
        gsap.fromTo(t, 0.5, { autoAlpha: 0 }, { autoAlpha: 1, display: "inline-block", ease: "none" }),
        gsap.fromTo(t + " h3", 1, { y: -50, autoAlpha: 0 }, { y: 0, autoAlpha: 1, ease: "expo.out" }),
        gsap.fromTo(t + " p", 1, { autoAlpha: 0 }, { autoAlpha: 1, ease: "expo.out" }),
        gsap.fromTo(t + " img", 1, { scale: 0.5, autoAlpha: 0 }, { scale: 1, autoAlpha: 1, ease: "expo.out" }),
        ($("#instructions-status").innerHTML = instructionsStep + " / " + instructionsTotal);
}
function settingsOpen() {
    gsap.fromTo("#settings", 0.25, { autoAlpha: 0 }, { autoAlpha: 1, display: "block", ease: "none" }), gsap.fromTo("#settings .modal-close", 1, { rotation: -90, autoAlpha: 0 }, { rotation: 0, autoAlpha: 1, ease: Expo.easeOut });
}
function settingsClose() {
    gsap.fromTo("#settings", 0.25, { autoAlpha: 1 }, { autoAlpha: 0, ease: "none" });
}
var isGravity = !1;
function toggleGravity() {
    isGravity
        ? ((isGravity = !1), $("#setting-gravity").classList.remove("active"), ($("#setting-gravity span").innerHTML = "OFF"))
...
function toggleEarthShape() {
    isFlatEarthCreated || createFlatEarth(),
        isFlatEarth
            ? ((isFlatEarth = !1), (earthObject.visible = !0), (flatEarthObject.visible = !1), ($("#setting-earth span").innerHTML = "OBLATE SPHEROID"))
            : ((isFlatEarth = !0), (earthObject.visible = !1), (flatEarthObject.visible = !0), ($("#setting-earth span").innerHTML = "FLAT"));
}
...
function onWindowResize() {
    (width = window.innerWidth), (height = window.innerHeight), (camera.aspect = width / height), camera.updateProjectionMatrix(), renderer.setSize(width, height), tooltipRenderer.setSize(width, height);
}
function onDocumentMouseDown(t) {
    !1 === isEventsEnabled || (t.preventDefault(), (isMouseDown = !0));
}
function onDocumentMouseMove(t) {
    !1 === isEventsEnabled || ((mouseX = 0.001 * (t.clientX - windowHalfX)), (mouseY = 0.001 * (t.clientY - windowHalfY)));
}
function onDocumentMouseUp(t) {
    !1 === isEventsEnabled || (t.preventDefault(), (isMouseDown = !1));
}
if (WEBGL.isWebGLAvailable()) (deviceSettings.isWebGL = !0), initWebgl();
else {
