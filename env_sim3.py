...
class Env:
    ...
    def compute_reward(self):
        ...
        if abs(self.state[0]) > 5.0:
            reward_x = -1.0 * (self.state[0] - 5) / 25   # 0 + (-1-0)*(x-5)/(30-5)
        else:
            reward_x = -2.0 * (self.state[0] - 5) / 5    # 0 + (2.0-0)*(x-5)/(0-5)

        if abs(self.state[1]) > 0.2:
            reward_y = -(abs(self.state[1]) - 0.2) / 2.8 # 0 + (-1-0)*(x-0.2)/(3-0.2)
        else:
            reward_y = -(abs(self.state[1]) - 0.2) / 0.2 # 0 + (1-0)*(x-0.2)/(0-0.2)
